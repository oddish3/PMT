...
#wd 
rm(list=ls())
setwd("~/Documents/R_folder/UG/PMT_ReplicationFiles_Stata/SY_Replication/Scripts")
...
#----
#MAIN FILE
data <- read_dta("~/Documents/R_folder/UG/PMT_ReplicationFiles_Stata/Brown_Ravallion_vandeWalle_PMT.dta")
...
folderPath <- "../dta_files"
if (!dir.exists(folderPath)) {
  dir.create(folderPath, recursive = TRUE)
}
write_dta(data, "../dta_files/PMT_CLEAN_SY.dta")
