...
#wd 
rm(list=ls())
setwd("C:/R folder/PMT_ReplicationFiles_Stata/Sol - Replication")
#----
library(dplyr)
library(tidyverse)
library(haven)
...
#MAIN FILE
data <- read_dta("C:/R folder/PMT_ReplicationFiles_Stata/Brown_Ravallion_vandeWalle_PMT.dta")
...
###
write_dta(data, "PMT_CLEAN_SY.dta")